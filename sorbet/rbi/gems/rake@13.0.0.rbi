...
class Rake::Application
  ...
  def init(app_name = _, argv = _); end
  ...
  def rake_require(file_name, paths = _, loaded = _); end
  def rakefile; end
  def rakefile_location(backtrace = _); end
...
class Rake::CpuCounter
  def count; end
  def count_with_default(default = _); end
...
module Rake::DSL
  ...
  def namespace(name = _, &block); end
...
module Rake::FileUtilsExt
  ...
  def self.nowrite_flag=(_); end
  def self.verbose_flag; end
  def self.verbose_flag=(_); end
end
...
class Rake::LinkedList
  ...
  def initialize(head, tail = _); end
...
class Rake::Task
  ...
  def enhance(deps = _, &block); end
  def execute(args = _); end
...
class Rake::TaskArguments
  ...
  def initialize(names, values, parent = _); end
...
module Rake::TaskManager
  ...
  def [](task_name, scopes = _); end
  def clear; end
  def create_rule(*args, &block); end
  def current_scope; end
  def define_task(task_class, *args, &block); end
  def enhance_with_matching_rule(task_name, level = _); end
  ...
  def lookup(task_name, initial_scope = _); end
  ...
  def self.record_task_metadata=(_); end
end
