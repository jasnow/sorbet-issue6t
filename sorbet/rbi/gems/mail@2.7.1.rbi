...
class Mail::AddressContainer < ::Array
  def initialize(field, list = _); end
...
class Mail::BccField < ::Mail::StructuredField
  ...
  def initialize(value = _, charset = _); end
...
class Mail::Body
  ...
  def empty?; end
  def encoded(transfer_encoding = _); end
  def encoding(val = _); end
  ...
  def multipart?; end
  def negotiate_best_encoding(message_encoding, allowed_encodings = _); end
  def parts; end
  def preamble; end
...
class Mail::Configuration
  ...
  def param_encode_language(value = _); end
  def retriever_method(method = _, settings = _); end
...
module Mail::Encodings
  ...
  def self.address_encode(address, charset = _); end
  def self.b_value_decode(str); end
  def self.b_value_encode(string, encoding = _); end
  ...
  def self.q_value_encode(encoded_str, encoding = _); end
  def self.register(name, cls); end
  def self.transcode_charset(str, from_charset, to_charset = _); end
...
class Mail::Encodings::TransferEncoding
  ...
  def self.negotiate(message_encoding, source_encoding, str, allowed_encodings = _); end
  def self.renegotiate(message_encoding, source_encoding, str, allowed_encodings = _); end
  def self.to_s; end
end
...
class Mail::Field
  ...
  def initialize(name, value = _, charset = _); end
  ...
  def self.parse(field, charset = _); end
...
class Mail::Header
  ...
  def initialize(header_text = _, charset = _); end
...
class Mail::IMAP < ::Mail::Retriever
  ...
  def delete_all(mailbox = _); end
  def find(options = _, &block); end
  def settings; end
  def settings=(_); end

  private

  def start(config = _, &block); end
...
class Mail::Multibyte::Chars
  ...
  def respond_to?(method, include_private = _); end
  def reverse; end
  ...
  def justify(integer, way, padstr = _); end
  def padding(padsize, padstr = _); end
...
module Mail::Parsers::AddressListsParser
  ...
  def self.en_comment_tail=(_); end
  def self.en_main; end
  def self.en_main=(_); end
  def self.error; end
  def self.error=(_); end
  def self.first_final; end
  def self.first_final=(_); end
...
class Mail::Part < ::Mail::Message
  def action; end
  def add_content_id(content_id_val = _); end
  def add_required_fields; end
  def add_required_message_fields; end
  def bounced?; end
  def cid; end
...
class Mail::Retriever
  def all(options = _, &block); end
  def find_and_delete(options = _, &block); end
  def first(options = _, &block); end
  def last(options = _, &block); end
end
...
class Mail::Ruby19
  def self.b_value_decode(str); end
  def self.b_value_encode(str, encoding = _); end
  def self.bracket(str); end
  def self.charset_encoder; end
  def self.charset_encoder=(_); end
  ...
  def self.q_value_decode(str); end
  def self.q_value_encode(str, encoding = _); end
  def self.string_byteslice(str, *args); end
  def self.transcode_charset(str, from_encoding, to_encoding = _); end
...
class Mail::StructuredField
  ...
  def initialize(name = _, value = _, charset = _); end
...
class Mail::UnstructuredField
  ...
  def initialize(name, value, charset = _); end
